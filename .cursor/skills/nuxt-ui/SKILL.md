...
> **Vue**: Add `class="isolate"` to your root `<html>` in `index.html`.
...
- Generated theme files — all slots, variants, and default classes for any component (Nuxt: `.nuxt/ui/*.ts`, Vue: `node_modules/.nuxt-ui/ui/*.ts`)
